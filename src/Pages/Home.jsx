...
const Home = () => {
  const handleDownload = () => {
    ...
    link.href = pdfUrl;
    link.download = "MadanaGopal_Resume.pdf"; // specify the filename
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Hello, I&apos;m{" "}
            <span style={{ color: "#33FFCC" }}>Madana Gopal!</span>
          </Text>
        </motion.div>
          ...
          <Flex gap={{ md: 6, base: 3 }}>
            ...
            <Flex gap={{ md: 5, base: 3 }}>
              ...
              <Flex
                ...
                borderColor={"brand.buttonGreen"}
                onClick={() => {
                  window.location.href = "https://github.com/Madhanagopal12";
                }}
                cursor={"pointer"}
              >
              ...
              <Flex
                ...
                onClick={() => {
                  window.location.href =
                    "https://www.linkedin.com/in/madanagopal004/";
                }}
                cursor={"pointer"}
              >
                <Icon
      ...
      <Flex
        ...
        pl={{ base: 10, lg: 0 }}
      >
        <Image src={homeRightImage} alt="right" />
      </Flex>
      {/* Right Side Ends */}
    </Flex>
  );
